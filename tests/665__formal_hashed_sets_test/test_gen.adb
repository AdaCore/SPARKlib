...
procedure Test_Gen with SPARK_Mode is
   ...
   begin
      ...
      --  Delete last inserted - at capacity
      Create_Non_Empty_Set (Y);
      P := Find (Y, 5);
      Delete (Y, P);

      Assert (Length (Y) = 4, "Delete last inserted at capacity, length is decremented");
      Assert (not Contains (Y, 5), "Delete last inserted at capacity, element is removed");
   ...
   begin
      ...
      Assert (Length (X) = 4, "Exclude, length is decremented");
      Assert (not Int_Sets_Keys.Contains (X, 3), "Exclude, element is removed");
      Assert (Element (X, Q) = 1, "Exclude, other elements are preserved");
   ...
   begin
      ...
      Assert (Length (X) = 4, "Delete element, length is decremented");
      Assert (not Int_Sets_Keys.Contains (X, 3), "Delete, element is removed");
      Assert (Element (X, Q) = 1, "Delete, other elements are preserved");
