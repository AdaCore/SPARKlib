...
package body SPARK.C.Constant_Strings
  with SPARK_Mode => Off
is
   ...
   is
      function Conv is new
        Ada.Unchecked_Conversion
          (const_char_array_access,
           Interfaces.C.Strings.char_array_access);
   begin
      return
        chars_ptr (Interfaces.C.Strings.To_Chars_Ptr (Conv (Item), Nul_Check));
   end To_Chars_Ptr;
