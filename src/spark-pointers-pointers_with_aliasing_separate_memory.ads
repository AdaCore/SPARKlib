...
is
   ...
   package Memory_Model is
      ...
      package Address_To_Object_Maps is new
        SPARK.Pointers.Abstract_Maps (Address_Type, 0, Object);
      ...
      function Valid (M : Memory_Map; A : Address_Type) return Boolean
      renames Address_To_Object_Maps.Has_Key;

      function Get (M : Memory_Map; A : Address_Type) return Object
      renames Address_To_Object_Maps.Get;
      ...
      package Address_Sets is new
        SPARK.Pointers.Abstract_Sets (Address_Type, 0);
