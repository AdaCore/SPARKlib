...
package body SPARK.Containers.Formal.Ordered_Maps
  with SPARK_Mode => Off
is
   ...
   begin
      Insert_Sans_Hint (Container.Content, Key, Position.Node, Inserted);
   end Insert;
   ...
   procedure Replace
     (Container : in out Map; Key : Key_Type; New_Item : Element_Type) is
   begin
      declare
