...
is
   ...
   with Global => null, Post => (SPARKlib_Full => Is_Empty (Empty_Map'Result));
   ...
   with
     ...
     Post           =>
       (SPARKlib_Full =>
          ...
          and Equivalent_Keys
                (Unbounded_Hashed_Maps.Key (Container, Position), Key)),
     Contract_Cases =>
       (SPARKlib_Full =>
       ...
       (SPARKlib_Full =>
          ...
          (not Contains (Model (Container), Key) => Find'Result = No_Element,
           ...
           others                                =>
             ...
             and Equivalent_Keys
                   (Unbounded_Hashed_Maps.Key (Container, Find'Result), Key)));
