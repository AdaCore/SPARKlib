...
is
   ...
   pragma Annotate
     (GNATprove, Inline_For_Proof, Entity => Equivalent_Elements);
   ...
   package Formal_Model with Ghost => SPARKlib_Logic is
      ...
      with
        ...
        Post   =>
          (SPARKlib_Full => E_Is_Find'Result =
               ...
               Find (Right, E.Get (Left, I)) > 0
                 and then Element_Logic_Equal
                    (E.Get (Right, Find (Right, E.Get (Left, I))),
                     E.Get (Left, I)));
      pragma Annotate
        (GNATprove, Inline_For_Proof, Entity => E_Elements_Included);
       ...
       (SPARKlib_Full =>
          ...
          (Contains (Container, New_Item) =>
             ...
             Model (Container)'Old = Model (Container)
               ...
               --  The element equivalent to New_Item in Container is replaced
               --  by New_Item.
     ...
     Post   =>
       (SPARKlib_Full =>
          E.Big (Length (Difference'Result)) = E.Big (Length (Left)) -
            ...
            and
              E_Elements_Included (Elements (Difference'Result),
                                   Elements (Left))
            and
              E_Elements_Included
                (Elements (Left),
   ...
   package Generic_Keys with SPARK_Mode, Always_Terminates is
      ...
      package Formal_Model with Ghost => SPARKlib_Logic is
         ...
         with
           ...
           Pre    => (SPARKlib_Defensive => Lst <= E.Last (Container)),
           Post   =>
             (SPARKlib_Full => E_Bigger_Than_Range'Result =
         ...
         with
           ...
           Pre    => (SPARKlib_Defensive => Lst <= E.Last (Container)),
           Post   =>
             (SPARKlib_Full => E_Smaller_Than_Range'Result =
                (for all I in Fst .. Lst =>
         ...
         with
           Global => null,
           Post   =>
             (SPARKlib_Full => M_Included_Except'Result =
                (for all E of Left =>
                   Contains (Right, E)
             ...
             ((for all E of Model (Container) =>
              ...
              others =>
                P.Has_Key (Positions (Container), Find'Result)
                  ...
                  and Equivalent_Keys
                     (Generic_Keys.Key
                        (Element (Container, Find'Result)), Key)));
