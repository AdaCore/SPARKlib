...
is
   ...
   generic
      ...
      with
        function Init_Prop (A : Element_In) return Boolean
        with Ghost;
     ...
     function Map (A : Array_In) return Array_Out
   with
     Pre  => (for all I in A'Range => Init_Prop (A (I))),
     Post =>
       Map'Result'First = A'First
   ...
   generic
      ...
      type Array_Out is array (Index_Type range <>) of Element_Out;
      with
        function Init_Prop (I : Index_Type; A : Element_In) return Boolean
        with Ghost;
      --  Potential additional constraint on values of the array to allow Map
     ...
     function Map_I (A : Array_In) return Array_Out
   with
     Pre  => (for all I in A'Range => Init_Prop (I, A (I))),
     Post =>
       Map_I'Result'First = A'First
       and then Map_I'Result'Last = A'Last
       and then (for all I in A'Range => Map_I'Result (I) = F (I, A (I)));
   ...
   generic
      ...
      with
        function Init_Prop (A : Element) return Boolean
        with Ghost;
      --  Potential additional constraint on values of the array to allow Map
     ...
     procedure Map_Proc (A : in out Array_Type)
   with
     Pre  => (for all I in A'Range => Init_Prop (A (I))),
   ...
   generic
      ...
      type Array_Type is array (Index_Type range <>) of Element;
      with
        function Init_Prop (I : Index_Type; A : Element) return Boolean
        with Ghost;
      --  Potential additional constraint on values of the array to allow Map
     ...
     procedure Map_I_Proc (A : in out Array_Type)
   with
     Pre  => (for all I in A'Range => Init_Prop (I, A (I))),
