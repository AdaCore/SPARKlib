...
generic
   ...
   with
     function Real (V : Fl) return Big_Real is <>
     with Ghost => Static;
   --  Conversion to Big_Real

package SPARK.Lemmas.Floating_Point_Arithmetic with
    SPARK_Mode,
    Ghost,
    Always_Terminates
is
   ...
   procedure Lemma_Add_Is_Monotonic (Val1 : Fl; Val2 : Fl; Val3 : Fl)
   with
     Ghost  => Static,
     Global => null,
     Pre    =>
       Val1 in Fl'First / 2.0 .. Fl'Last / 2.0
       and then Val2 in Fl'First / 2.0 .. Fl'Last / 2.0
       and then Val3 in Fl'First / 2.0 .. Fl'Last / 2.0
       and then Val1 <= Val2,
     Post   => Val1 + Val3 <= Val2 + Val3;

   procedure Lemma_Sub_Is_Monotonic (Val1 : Fl; Val2 : Fl; Val3 : Fl)
   with
     Ghost  => Static,
     Global => null,
     Pre    =>
   ...
   procedure Lemma_Mult_Is_Monotonic (Val1 : Fl; Val2 : Fl; Val3 : Fl)
   with
     Ghost  => Static,
     Global => null,
     Pre    =>
       Val1 in -Fl_Last_Sqrt .. Fl_Last_Sqrt
       and then Val2 in -Fl_Last_Sqrt .. Fl_Last_Sqrt
       and then Val3 in 0.0 .. Fl_Last_Sqrt
       and then Val1 <= Val2,
     Post   => Val1 * Val3 <= Val2 * Val3;  --  COLIBRI

   procedure Lemma_Mult_Right_Negative_Is_Monotonic
     (Val1 : Fl; Val2 : Fl; Val3 : Fl)
   with
     Ghost  => Static,
     Global => null,
     Pre    =>
       Val1 in -Fl_Last_Sqrt .. Fl_Last_Sqrt
       and then Val2 in -Fl_Last_Sqrt .. Fl_Last_Sqrt
       and then Val3 in -Fl_Last_Sqrt .. 0.0
       and then Val1 <= Val2,
     Post   => Val2 * Val3 <= Val1 * Val3;  --  COLIBRI

   procedure Lemma_Mult_By_Less_Than_One (Val1 : Fl; Val2 : Fl)
   with
     Ghost  => Static,
     Global => null,
   ...
   procedure Lemma_Div_Is_Monotonic (Val1 : Fl; Val2 : Fl; Val3 : Fl)
   with
     Ghost  => Static,
     Global => null,
     Pre    =>
   ...
   procedure Lemma_Div_Left_Is_Monotonic (Val1 : Fl; Val2 : Fl; Val3 : Fl)
   with
     Ghost  => Static,
     Global => null,
     Pre    =>
   ...
   function Is_Integer_32 (F : Fl) return Boolean
   is
      --  Protect against overflow in the conversion below
   ...
   function Is_Float (I : Integer_64) return Boolean
   is
      --  Protect against overflow in the conversion below
   ...
   --  64-bits, depending on the current instance of the generic) float
   function Is_Float (I : Integer_32) return Boolean
   is
      --  Protect against overflow in the conversion below
   ...
   function Is_Integer (F : Fl) return Boolean
   is
   ...
   package Integer_64_Conversions
     with Ghost => Static
   is
      package Inst is new Signed_Conversions (Int);
   end Integer_64_Conversions;

   function Big (X : Int) return Big_Integer
   renames Integer_64_Conversions.Inst.To_Big_Integer;

   procedure Lemma_Integer_Add_Exact (Val1, Val2 : Fl; Int1, Int2 : Int)
   with
     Ghost => Static,
     Pre   =>
       Val1 = Fl (Int1)
       and then In_Range (Big (Int1), -Max_Int, Max_Int)
       and then Val2 = Fl (Int2)
       and then In_Range (Big (Int2), -Max_Int, Max_Int)
       and then In_Range (Big (Int1) + Big (Int2), -Max_Int, Max_Int),
     Post  => Val1 + Val2 = Fl (Int1 + Int2);

   procedure Lemma_Integer_Sub_Exact (Val1, Val2 : Fl; Int1, Int2 : Int)
   with
     Ghost => Static,
     Pre   =>
       Val1 = Fl (Int1)
   ...
   procedure Lemma_Integer_Mul_Exact (Val1, Val2 : Fl; Int1, Int2 : Int)
   with
     Ghost => Static,
     Pre   =>
       Val1 = Fl (Int1)
   ...
   procedure Lemma_Rounding_Error_Add (Val1, Val2 : Fl)
   with
     Ghost => Static,
     Pre   =>
       Val1 in Fl'First / 2.0 .. Fl'Last / 2.0
   ...
   procedure Lemma_Rounding_Error_Sub (Val1, Val2 : Fl)
   with
     Ghost => Static,
     Pre   =>
       Val1 in Fl'First / 2.0 .. Fl'Last / 2.0
   ...
   procedure Lemma_Rounding_Error_Mul (Val1, Val2 : Fl)
   with
     Ghost => Static,
     Pre   =>
       Val1 in -Fl_Last_Sqrt .. Fl_Last_Sqrt
   ...
   procedure Lemma_Rounding_Error_Div (Val1, Val2 : Fl)
   with
     Ghost => Static,
     Pre   =>
       Val1 in -Fl_Last_Sqrt .. Fl_Last_Sqrt
